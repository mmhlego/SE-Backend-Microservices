...
namespace YourNamespace.Controllers
{
	...
	public class CategoryController : ControllerBase
	{
		...
		public ActionResult<StatusResponse> AddSubcategory([FromBody] SubcategoryRequests subcategoryRequests)
		{
		...
		[Route("/categories/{id}")]
		[Authorize(Roles = "Admin , StoreKeeper")]
		public ActionResult<StatusResponse> UpdateCategory([FromQuery] Guid id, [FromBody] CategoryRequests categoryRequests)
		{
