...
namespace General.API.Services
{
    public class BookmarkService : IBookmarkService
    {
        ...
        public List<Bookmark> GetBookmarksByUserId(Guid userId)
        {
            ...
            {
                throw new Exception("An error occured while getting bookmarks by userId", ex);
            }
        }
        public List<Bookmark> GetBookmarksByUserIdAndProductId(Guid userId, Guid productId)
        {
            ...
            {
                throw new Exception("An error occured while getting bookmarks by userId and productId", ex);
            }
        }
        ...
        public bool AddBookmark(Guid userId, Guid productId)
        {
            ...
            {
                throw new Exception("An error occured while adding a bookmark", ex);
            }
        }
        ...
        public bool DeleteBookmark(Bookmark bookmark)
        {
            try
            {
                ...
                var b = _context.Bookmarks.SingleOrDefault(b => b.Id == bookmark.Id);
                if(b == null)
                {
